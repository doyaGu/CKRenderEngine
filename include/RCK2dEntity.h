...
public:
    ...
    *************************************************/
    virtual CKERROR GetPosition(Vx2DVector &vect, CKBOOL hom = FALSE, CK2dEntity *ref = NULL);
    ...
    *************************************************/
    virtual void SetPosition(const Vx2DVector &vect, CKBOOL hom = FALSE, CKBOOL KeepChildren = FALSE, CK2dEntity *ref = NULL);
    ...
    *************************************************/
    virtual CKERROR GetSize(Vx2DVector &vect, CKBOOL hom = FALSE);
    ...
    *************************************************/
    virtual void SetSize(const Vx2DVector &vect, CKBOOL hom = FALSE, CKBOOL KeepChildren = FALSE);
    ...
    *************************************************/
    virtual void SetRect(const VxRect &rect, CKBOOL KeepChildren = FALSE);
    ...
    *************************************************/
    virtual void GetRect(VxRect &rect);
    ...
    *************************************************/
    virtual CKERROR SetHomogeneousRect(const VxRect &rect, CKBOOL KeepChildren = FALSE);
    ...
    *************************************************/
    virtual CKERROR GetHomogeneousRect(VxRect &rect);
    ...
    *************************************************/
    virtual void SetSourceRect(VxRect &rect);
    ...
    *************************************************/
    virtual void GetSourceRect(VxRect &rect);
    ...
    *************************************************/
    virtual void UseSourceRect(CKBOOL Use = TRUE);
    ...
    *************************************************/
    virtual CKBOOL IsUsingSourceRect();
    ...
    *************************************************/
    virtual void SetBackground(CKBOOL back = TRUE);
    ...
    *************************************************/
    virtual void SetClipToParent(CKBOOL clip = TRUE);
    ...
    *************************************************/
    virtual void ModifyFlags(CKDWORD add, CKDWORD remove = 0);
    ...
    *************************************************/
    virtual void EnableRatioOffset(CKBOOL Ratio = TRUE);
    ...
    *************************************************/
    ...
    See also:GetParent
    *************************************************/
    virtual CKBOOL SetParent(CK2dEntity *parent);
    ...
    See also: SetParent
    *************************************************/
    virtual CK2dEntity *GetParent() const;
    ...
    *************************************************/
    virtual CK2dEntity *GetChild(int i) const;
    ...
    ************************************************/
    virtual CK2dEntity *HierarchyParser(CK2dEntity *current) const;
    ...
    *************************************************/
    virtual void SetMaterial(CKMaterial *mat);
    ...
    *************************************************/
    virtual CKMaterial *GetMaterial();
    ...
    *************************************************/
    virtual void SetHomogeneousCoordinates(CKBOOL Coord = TRUE);
    ...
    *************************************************/
    virtual CKBOOL IsHomogeneousCoordinates();
    ...
    *************************************************/
    virtual void EnableClipToCamera(CKBOOL Clip = TRUE);
    ...
    *************************************************/
    virtual CKBOOL IsClippedToCamera();
    ...
    See also: Draw
    *************************************************/
    virtual CKERROR Render(CKRenderContext *context);
    ...
    See Also: Render
    *************************************************/
    virtual CKERROR Draw(CKRenderContext *context);

    //------------------------------------------------
    // Extents (Surface actually rendered)

    virtual void GetExtents(VxRect &srcrect, VxRect &rect);

    virtual void SetExtents(const VxRect &srcrect, const VxRect &rect);
    ...
    See Also:
    *************************************************/
    virtual void RestoreInitialSize();
    ...
    *************************************************/
    ...
    static CK2dEntity *CreateInstance(CKContext *Context);
...
protected:
    ...
    VxRect m_SrcRect;
    CKDWORD m_Flags;
    RCK2dEntity *m_Parent;
    RCKMaterial *m_Material;
    XArray<RCK2dEntity> m_Children;
    VxRect m_SourceRect;
    CKDWORD m_ZOrder;
};
