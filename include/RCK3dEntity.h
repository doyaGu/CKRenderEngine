...
public:
    ...
    ************************************************/
    virtual RCK3dEntity *GetChild(int pos) const;
    ...
    ************************************************/
    virtual CKBOOL SetParent(RCK3dEntity *Parent, CKBOOL KeepWorldPos = TRUE);
    ...
    *************************************************/
    virtual RCK3dEntity *GetParent() const;
    ...
    ************************************************/
    virtual CKBOOL AddChild(RCK3dEntity *Child, CKBOOL KeepWorldPos = TRUE);
    ...
    ************************************************/
    virtual CKBOOL AddChildren(const XObjectPointerArray &Children, CKBOOL KeepWorldPos = TRUE);
    ...
    ************************************************/
    virtual CKBOOL RemoveChild(RCK3dEntity *Mov);

    /*************************************************
    Summary: Compares the hierarchy of two entities.
    Arguments:
        Mov: A CK3dEntity to compare with this entity.
        SameOrder: Each children must be in the same order in both entities.
    Remarks:
    ...
    *************************************************/
    virtual CKBOOL CheckIfSameKindOfHierarchy(RCK3dEntity *Mov, CKBOOL SameOrder = FALSE) const;
    ...
    See also: GetChildrenCount,GetChildren
    ************************************************/
    virtual RCK3dEntity *HierarchyParser(RCK3dEntity *current) const;
    ...
    *************************************************/
    virtual CKDWORD GetFlags() const;
    ...
    *************************************************/
    virtual void SetFlags(CKDWORD Flags);
    ...
    ************************************************/
    virtual void SetPickable(CKBOOL Pick = TRUE);
    ...
    ************************************************/
    virtual CKBOOL IsPickable() const;
    ...
    ************************************************/
    virtual void SetRenderChannels(CKBOOL RenderChannels = TRUE);
    ...
    ************************************************/
    virtual CKBOOL AreRenderChannelsVisible() const;
    ...
    ************************************************/
    virtual CKBOOL IsInViewFrustrum(CKRenderContext *Dev, CKDWORD Flags = 0);
    ...
    ************************************************/
    virtual CKBOOL IsInViewFrustrumHierarchic(CKRenderContext *Dev);
    ...
    *************************************************/
    virtual void IgnoreAnimations(CKBOOL ignore = TRUE);

    virtual CKBOOL AreAnimationIgnored() const;
    ...
    ************************************************/
    virtual CKBOOL IsAllInsideFrustrum() const;
    ...
    See also: IsInViewFrustrum, IsInViewFrustrumHierarchic,Render,IsAllInsideFrustrum
    ************************************************/
    virtual CKBOOL IsAllOutsideFrustrum() const;
    ...
    Remarks:
    o Render Engines may execute special processing for transparent object: In most
    ...
    *************************************************/
    virtual void SetRenderAsTransparent(CKBOOL Trans = TRUE);
    ...
    *************************************************/
    virtual CKDWORD GetMoveableFlags() const;

    virtual void SetMoveableFlags(CKDWORD flags);
    ...
    See also: VX_MOVEABLE_FLAGS,GetMoveableFlags,ModifyMoveableFlags
    *************************************************/
    virtual CKDWORD ModifyMoveableFlags(CKDWORD Add, CKDWORD Remove);
    ...
    *************************************************/
    virtual RCKMesh *GetCurrentMesh() const;
    ...
    *************************************************/
    virtual RCKMesh *SetCurrentMesh(RCKMesh *m, CKBOOL add_if_not_here = TRUE);
    ...
    *************************************************/
    ...
    See Also:Using Meshes,GetCurrentMesh,SetCurrentMesh,GetMesh,AddMesh
    *************************************************/
    virtual RCKMesh *GetMesh(int pos) const;
    ...
    *************************************************/
    virtual CKERROR AddMesh(RCKMesh *mesh);
    ...
    *************************************************/
    virtual CKERROR RemoveMesh(RCKMesh *mesh);

    //-------------------------------------------------------
    // ORIENTATION POSITION SCALE
    // Default Referential : World
    ...
    ************************************************/
    virtual void LookAt(const VxVector *Pos, RCK3dEntity *Ref = NULL, CKBOOL KeepChildren = FALSE);
    ...
    See also: SetOrientation, GetOrientation
    ************************************************/
    virtual void Rotate3f(float X, float Y, float Z, float Angle, RCK3dEntity *Ref = NULL, CKBOOL KeepChildren = FALSE);

    virtual void Rotate(const VxVector *Axis, float Angle, RCK3dEntity *Ref = NULL, CKBOOL KeepChildren = FALSE);
    ...
    ************************************************/
    virtual void Translate3f(float X, float Y, float Z, RCK3dEntity *Ref = NULL, CKBOOL KeepChildren = FALSE);

    virtual void Translate(const VxVector *Vect, RCK3dEntity *Ref = NULL, CKBOOL KeepChildren = FALSE);
    ...
    ************************************************/
    virtual void AddScale3f(float X, float Y, float Z, CKBOOL KeepChildren = FALSE, CKBOOL Local = TRUE);

    virtual void AddScale(const VxVector *Scale, CKBOOL KeepChildren = FALSE, CKBOOL Local = TRUE);
    ...
    See also: Translate
    ************************************************/
    virtual void SetPosition3f(float X, float Y, float Z, RCK3dEntity *Ref = NULL, CKBOOL KeepChildren = FALSE);

    virtual void SetPosition(const VxVector *Pos, RCK3dEntity *Ref = NULL, CKBOOL KeepChildren = FALSE);
    ...
    *************************************************/
    virtual void GetPosition(VxVector *Pos, RCK3dEntity *Ref = NULL) const;
    ...
    ************************************************/
    virtual void SetOrientation(const VxVector *Dir, const VxVector *Up, const VxVector *Right = NULL, RCK3dEntity *Ref = NULL, CKBOOL KeepChildren = FALSE);
    ...
    *************************************************/
    virtual void GetOrientation(VxVector *Dir, VxVector *Up, VxVector *Right = NULL, RCK3dEntity *Ref = NULL);
    ...
    ************************************************/
    virtual void SetQuaternion(const VxQuaternion *Quat, RCK3dEntity *Ref = NULL, CKBOOL KeepChildren = FALSE, CKBOOL KeepScale = FALSE);
    ...
    *************************************************/
    virtual void GetQuaternion(VxQuaternion *Quat, RCK3dEntity *Ref = NULL);
    ...
    See also: GetScale, AddScale
    ************************************************/
    virtual void SetScale3f(float X, float Y, float Z, CKBOOL KeepChildren = FALSE, CKBOOL Local = TRUE);

    virtual void SetScale(const VxVector *Scale, CKBOOL KeepChildren = FALSE, CKBOOL Local = TRUE);
    ...
    *************************************************/
    virtual void GetScale(VxVector *Scale, CKBOOL Local = TRUE);
    ...
    ************************************************/
    virtual CKBOOL ConstructWorldMatrix(const VxVector *Pos, const VxVector *Scale, const VxQuaternion *Quat);

    virtual CKBOOL ConstructWorldMatrixEx(const VxVector *Pos, const VxVector *Scale, const VxQuaternion *Quat, const VxQuaternion *Shear, float Sign);

    virtual CKBOOL ConstructLocalMatrix(const VxVector *Pos, const VxVector *Scale, const VxQuaternion *Quat);

    virtual CKBOOL ConstructLocalMatrixEx(const VxVector *Pos, const VxVector *Scale, const VxQuaternion *Quat, const VxQuaternion *Shear, float Sign);
    ...
    ************************************************/
    virtual CKBOOL Render(CKRenderContext *Dev, CKDWORD Flags = CKRENDER_UPDATEEXTENTS);
    ...
    Return Value:
        Returns 0 if not intersection occurred or the number of faces intersected otherwise.
    ...
    ************************************************/
    virtual int RayIntersection(const VxVector *Pos1, const VxVector *Pos2, VxIntersectionDesc *Desc, RCK3dEntity *Ref, CK_RAYINTERSECTION iOptions = CKRAYINTERSECTION_DEFAULT);
    ...
    *************************************************/
    virtual void GetRenderExtents(VxRect &rect) const;
    ...
    ***************************************************************************/
    virtual const VxMatrix &GetLastFrameMatrix() const;
    ...
    ************************************************/
    virtual void SetLocalMatrix(const VxMatrix &Mat, CKBOOL KeepChildren = FALSE);
    ...
    *************************************************/
    virtual const VxMatrix &GetLocalMatrix() const;
    ...
    ************************************************/
    virtual void SetWorldMatrix(const VxMatrix &Mat, CKBOOL KeepChildren = FALSE);
    ...
    See also: SetLocalMatrix,GetLocalMatrix,GetWorldMatrix,GetInverseWorldMatrix
    *************************************************/
    virtual const VxMatrix &GetWorldMatrix() const;
    ...
    ************************************************/
    virtual const VxMatrix &GetInverseWorldMatrix() const;
    ...
    ************************************************/
    virtual void Transform(VxVector *Dest, const VxVector *Src, RCK3dEntity *Ref = NULL) const;
    ...
    ************************************************/
    virtual void InverseTransform(VxVector *Dest, const VxVector *Src, RCK3dEntity *Ref = NULL) const;

    virtual void TransformVector(VxVector *Dest, const VxVector *Src, RCK3dEntity *Ref = NULL) const;

    virtual void InverseTransformVector(VxVector *Dest, const VxVector *Src, RCK3dEntity *Ref = NULL) const;
    ...
    ************************************************/
    virtual void TransformMany(VxVector *Dest, const VxVector *Src, int count, RCK3dEntity *Ref = NULL) const;
    ...
    ************************************************/
    virtual void InverseTransformMany(VxVector *Dest, const VxVector *Src, int count, RCK3dEntity *Ref = NULL) const;
    ...
    ************************************************/
    virtual void ChangeReferential(RCK3dEntity *Ref = NULL);
    ...
    *************************************************/
    virtual CKPlace *GetReferencePlace() const;
    ...
    *************************************************/
    virtual void AddObjectAnimation(CKObjectAnimation *anim);
    ...
    *************************************************/
    virtual void RemoveObjectAnimation(CKObjectAnimation *anim);
    ...
    *************************************************/
    virtual CKObjectAnimation *GetObjectAnimation(int index) const;
    ...
    *************************************************/
    virtual int GetObjectAnimationCount() const;
    ...
    *************************************************/
    virtual RCKSkin *GetSkin() const;

    virtual void UpdateBox(CKBOOL World = TRUE);
    ...
    ************************************************/
    virtual const VxBbox &GetBoundingBox(CKBOOL Local = FALSE);
    ...
    ************************************************/
    virtual CKBOOL SetBoundingBox(const VxBbox *BBox, CKBOOL Local = FALSE);
    ...
    ************************************************/
    virtual const VxBbox &GetHierarchicalBox(CKBOOL Local = FALSE);
    ...
    ************************************************/
    virtual CKBOOL GetBaryCenter(VxVector *Pos);
